...
function Details() {
  const client_id = useSearchParams().get("client_id");
  ...
  const totalWithBonus = useMemo(() => {
    ...
    return total + (total * bonusPercent) / 100;
  }, [total]);
    ...
    <div>
      ...
      <div className="flex justify-between items-center px-8 py-4">
        <div className="flex gap-2">
          ...
          <button
            onClick={() => {
              console.log({ products, services, total });
            }}
        ...
        <div>
          <div className="card bg-secondary flex rounded-2xl">
            <div className="flex flex-col justify-center items-center px-8 py-4 border-r border-gray-300">
              <h1 className="font-medium">Total</h1>
              <p className="text-lg">{total.toLocaleString()} DA</p>
            </div>
            <div className="flex flex-col justify-center items-center px-8 py-4">
              <h1 className="font-medium">Total with Bonus</h1>
              <p className="text-lg">{totalWithBonus.toLocaleString()} DA</p>
            </div>
          </div>
